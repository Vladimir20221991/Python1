...
koef1 = create_mn(k1)
koef2 = create_mn(k2)
write_file("задача1сем5.txt", create_str(koef1))
write_file("задача1ф2сем5.txt", create_str(koef2))

# нахождение суммы многочлена

with open('задача1сем5.txt', 'r') as data:
    st1 = data.readlines()
with open('задача1ф2сем5.txt', 'r') as data:
    st2 = data.readlines()
...
write_file("задача1сем5.txt", create_str(lst_new))
with open('задача1ф2сем5.txt', 'r') as data:
    st3 = data.readlines()
